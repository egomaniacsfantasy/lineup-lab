...
function buildPricing(leagueId: string, pricingMode: 'empty' | 'live'): LeaguePricing {
  const lines = [
    ...
    lineFor(
      MATCHUP_IDS.apollo,
      { rosterId: 3, moneyline: -214, winProbability: 68.1, projection: 154.2, spread: 10.7, total: 297.7 },
      { rosterId: 4, moneyline: 176, winProbability: 31.9, projection: 143.5, spread: -10.7, total: 297.7 },
    ),
    lineFor(
      MATCHUP_IDS.poseidon,
      { rosterId: 5, moneyline: -122, winProbability: 54.9, projection: 147.3, spread: 3.1, total: 291.5 },
      { rosterId: 6, moneyline: 104, winProbability: 45.1, projection: 144.2, spread: -3.1, total: 291.5 },
    ),
  ];
